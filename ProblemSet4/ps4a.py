...
def isValidWord(word, hand, wordList):
    ...
    wordIsOk=False
    handCopy = hand.copy()
    worldListCopy = wordList.copy()    
    if word in worldListCopy:
        for letter in word:
...
def playGame(wordList):
    ...
    while dealOption == 'r' and isFirstHand:
